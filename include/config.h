...
using QgemulAdd_1_t = Qu<intBits<1>, fracBits<6>>;
using QgemulAdd_2_t = Qu<intBits<2>, fracBits<6>>;
...
using QgemulMul_t = Qu<intBits<0>, fracBits<6>>;

using QgemvAdd_1_t = Qu<intBits<4>, fracBits<4>>;
...
using QpotrsForwardSub_t = Qu<intBits<6>, fracBits<1>>;
